  ...
  return (
    <div className="w-full">
      <header className="mb-4">
        <h1 className="text-center text-xl">Gestion de stock</h1>
      ...
      <section className="relative overflow-x-auto shadow-md items-center mx-auto">
        <Table
          thead={
            <>
          ...
          tbody={products.map((e) => (
            <tr>
              ...
              <td>{e.nombre}</td>
              <td>{e.categoriaId.nombre}</td>
              <td>{e.marcaId.nombre}</td>
              <td>{e.cantidad}</td>
              <td>{e.productoProveedors[0].proveedor.nombreProveedor}</td>
              <td>{formatMoneyUSD(e.productoProveedors[0].precioCosto)}</td>
              <td>{formatMoneyUSD(e.productoProveedors[0].precioVenta)}</td>
              <td>{formatMoneyUSD(e.productoProveedors[0].precioMayorista)}</td>
            </tr>
          ))}
        />
